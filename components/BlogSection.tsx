    ...
    <section className="blog-section p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="blog-post bg-white shadow-lg rounded-lg overflow-hidden">
          <img src="/path-to-blog-image1.jpg" alt="Blog Post" className="w-full h-40 object-cover"/>
          <div className="p-4">
        ...
        <div className="blog-post bg-white shadow-lg rounded-lg overflow-hidden">
          <img src="/path-to-blog-image2.jpg" alt="Blog Post" className="w-full h-40 object-cover"/>
          <div className="p-4">
